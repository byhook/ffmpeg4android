...
本节内容旨在了解`本地视频的解码播放过程`，暂时不设计`音频的解码同步播放`操作。

## 流程分析

![](https://github.com/byhook/blog/blob/master/ndk/images/2018120114105069.png)

## 工程实践

**新建工程`ffmpeg-single-play`**

![](https://github.com/byhook/blog/blob/master/ndk/images/20181201134210831.png)
...
![](https://github.com/byhook/blog/blob/master/ndk/images/20181201142000706.png)

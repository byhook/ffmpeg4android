...
import com.onzhou.ffmpeg.cmake.R;
 ...
 * @description:
 */
public class CmakeHelloActivity extends AbsBaseActivity {
    ...
    private CmakeHello cmakeHello;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ffmpeg_cmake_hello);
        setupViews();
        cmakeHello = new CmakeHello();
    }
